...
public class p1 {
  ...
  @Test
  public void test() {
    int[][] ints = ArrayUtil.convertStringTwoDimensionIntArray(
    ...
    System.out.println(checkValid(ints));
  ...
  @Test
  public void test2() {
    int[][] ints = ArrayUtil.convertStringTwoDimensionIntArray("[[1,2,3],[3,1,2],[2,3,1]]");
    ArrayUtil.printTwoDemimalIntArray(ints);
    System.out.println(checkValid(ints));
  }
  ...
  private boolean checkCol(int[][] matrix, int i, int col) {
    int[] colArr = new int[col];
    for (int j = 0; j < col; j++) {
      colArr[j] = matrix[j][i];
    }
    return checkRow(colArr);

  }

  private boolean checkRow(int[] matrix) {
